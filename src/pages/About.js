...
`
  return (
    <div className="about">
      <div data-aos="fade-up" className="aboutTop" style={{backgroundImage:`url(${AntGroup})`}}>
      ...
      <div data-aos="fade-up" className="aboutBottom">
       ...
       <div className='img-about' style={{backgroundImage:`url(${ImgAbout})`}}>
       <div className="overlay-about"></div>
         <h1>RƏQƏMLƏRLƏ BİZ :</h1>
           <h4 data-aos="fade-left"><span>QURULUŞ </span><i class="fas fa-long-arrow-alt-right"></i> 2007</h4>
           <h4 data-aos="fade-left"><span>ŞİRKƏTLƏR </span><i class="fas fa-long-arrow-alt-right"></i> 3 ( TOKYO , ISTANBUL ,NEW YORK )</h4>
           <h4 data-aos="fade-left"><span>İŞ HƏCMİ </span><i class="fas fa-long-arrow-alt-right"></i> 70M $</h4> 
      </div>
      <div data-aos="fade-up-right" className='targets'>
         <h1>HƏDƏFLƏRİMİZ <i class="far fa-hand-point-right"></i></h1>
         <h4>Çində doğulan bir dünya markası olmaq. Çalışdığımız coğrafiyanı genişləndirərək hədəf yeni bazarlarla məşğulluq imkanları yaratmaqdır.
              Çində inkişaf etdirdiyimiz yenilikçi iş modelləri ilə dünya miqyasında xidmət istehsal edə biləcək gənc bir marka olaraq yolumuza davam etmək.
         </h4>
      </div>
      ...
      <div className='why-about' style={{backgroundImage:`url(${ImgWhy})`}}>
          ...
          <div data-aos="fade-down"  className='why-txt-1'>
             ...
             <h3>Bizə keçmiş iş təcrübələrinizdən maraqlı anlardan danışın <i id='greenicon' class="fas fa-check"></i></h3>
          </div>
          <div data-aos="fade-right" className='why-txt-2'>
             <h3>5 ildən sonra özünüzü harda görürsünüz ? <i id='redicon' class="fas fa-times"></i></h3> 
             <h3>İcazə verin bizimlə yaxşı çalışacağınız təqdirdə 5 ildən sonra harda olacağınızı deyim <i id='greenicon' class="fas fa-check"></i></h3>
          </div>
          <div data-aos="fade-down" className='why-txt-3'>
             <h3>Stresə dəvamlı namizəd <i id='redicon' class="fas fa-times"></i></h3> 
             <h3>Task/time management-i yaxşı olan namizəd <i id='greenicon' class="fas fa-check"></i></h3>
          </div>
      </div>
    </div>
