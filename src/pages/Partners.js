...
const Partners = () => {
    ...
    return (
        <div className='Aos'>
            <div className='grids'>
                <div data-aos="fade-up" className='grid-back' style={{ backgroundImage: `url(${QurucuBack})` }}>
                ...
                <div data-aos="fade-up-right" className='krc-txt'>
                    <h3>Kalancik :</h3>
                    <div data-aos="zoom-in" style={{ backgroundImage: `url(${Kurucu})`}} className='boxes-rsp'></div> 
                       <p>
                ...
                <div data-aos="zoom-in" style={{ backgroundImage: `url(${Kurucu})`}} className='boxes'></div> 
                </div>
                <div className='grids-2'> 
                <div data-aos="zoom-in-up" style={{ backgroundImage: `url(${Kurucu2})`}} className='boxes'></div>   
                <div data-aos="fade-up" className='krc2-txt'>
                    <h3>Weiner :</h3>
                    <div data-aos="zoom-in" style={{ backgroundImage: `url(${Kurucu2})`}} className='boxes-rsp'></div> 
                <p>
                        <ReactReadMoreReadLess
                            charLimit={200}
                            readMoreText={"Daha çox ▼"}
